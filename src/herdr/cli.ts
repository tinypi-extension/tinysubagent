...
/**
 * The plugin directory this package ships, re-exported from `./paths.ts` so the
 * link instruction names a real path whatever the install method.
 */
export { pluginDir } from "../paths.ts";
